...
class ResumeAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', 'author', 'info', 'email', 'phone', 'telegram', 'linkedin', 'facebook',
                     'is_published', 'created_at', 'updated_at')
    fields = ('name', 'author', 'info', 'email', 'phone', 'telegram', 'linkedin', 'facebook', 'is_published')
    readonly_fields = ['id']


class EducationAdmin(admin.ModelAdmin):
    list_display = ('resume', 'institution_name', 'speciality', 'category_education', 'start_date', 'finish_date',
                    'faculty', 'created_at', 'updated_at')
    list_filter = ('resume', 'institution_name', 'speciality', 'category_education', 'start_date', 'finish_date',
                   'faculty', 'created_at', 'updated_at')
    search_fields = ('resume', 'institution_name', 'speciality', 'category_education', 'start_date', 'finish_date',
                     'faculty')
    fields = ('resume', 'institution_name', 'speciality', 'category_education', 'start_date', 'finish_date',
              'faculty')
    readonly_fields = ['id']


class ExperienceAdmin(admin.ModelAdmin):
    list_display = ('resume', 'company', 'job_title', 'start_date', 'end_date', 'created_at', 'updated_at')
    list_filter = ('resume', 'company', 'job_title', 'start_date', 'end_date')
    search_fields = ('resume', 'company', 'job_title', 'start_date', 'end_date')
    fields = ('resume', 'company', 'job_title', 'start_date', 'end_date')
    readonly_fields = ['id']
